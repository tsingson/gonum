...
var testGraphs = []struct {
	...
	},
	{
		...
		//   9 : 3 5 6;
		g:   "IsP@PGXD_",
		bin: "10:110100010001000001010001001000011001000101100000",
		want: []set{
			0: linksToInt(1, 2, 3),
			1: linksToInt(0, 4, 5),
			2: linksToInt(0, 6, 7),
	...
	},
	{
		...
		bin: "17:101001000101001000001000000100000001000000001000000000100000001001000000000001000000001000100100000001001100010000000001100100100100100000",
		want: []set{
